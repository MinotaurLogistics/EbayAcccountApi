...
class PrivilegeApi
{
     ...
     * @return \Swagger\EbayAccountClient\Model\SellingPrivileges
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\SellingPrivileges, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrivilegesWithHttpInfo()
    {
        $returnType = '\Swagger\EbayAccountClient\Model\SellingPrivileges';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\SellingPrivileges',
