...
class RateTableApi
{
     ...
     * @return \Swagger\EbayAccountClient\Model\RateTableResponse
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\RateTableResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRateTablesWithHttpInfo($country_code = null)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\RateTableResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\RateTableResponse',
