...
class PaymentPolicyApi
{
     ...
     *
     * @param  \Swagger\EbayAccountClient\Model\PaymentPolicyRequest $body Payment policy request (required)
     *
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayAccountClient\Model\SetPaymentPolicyResponse
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\SetPaymentPolicyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPaymentPolicyWithHttpInfo($body)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\SetPaymentPolicyResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\SetPaymentPolicyResponse',
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayAccountClient\Model\PaymentPolicyResponse
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\PaymentPolicyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentPoliciesWithHttpInfo($marketplace_id)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\PaymentPolicyResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\PaymentPolicyResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayAccountClient\Model\PaymentPolicy
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\PaymentPolicy, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentPolicyWithHttpInfo($payment_policy_id)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\PaymentPolicy';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\PaymentPolicy',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
