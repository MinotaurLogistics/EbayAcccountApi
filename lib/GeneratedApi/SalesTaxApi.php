...
class SalesTaxApi
{
     ...
     * @param  \Swagger\EbayAccountClient\Model\SalesTaxBase $body A container that describes the how the sales tax is calculated. (required)
     *
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayAccountClient\Model\SalesTax
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\SalesTax, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSalesTaxWithHttpInfo($country_code, $jurisdiction_id)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\SalesTax';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\SalesTax',
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayAccountClient\Model\SalesTaxes
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\SalesTaxes, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSalesTaxesWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\SalesTaxes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\SalesTaxes',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
