...
class PaymentsProgramApi
{
     ...
     * @return \Swagger\EbayAccountClient\Model\PaymentsProgramResponse
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\PaymentsProgramResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsProgramWithHttpInfo($marketplace_id, $payments_program_type)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\PaymentsProgramResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\PaymentsProgramResponse',
