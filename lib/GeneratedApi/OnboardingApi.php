...
class OnboardingApi
{
     ...
     * @return \Swagger\EbayAccountClient\Model\PaymentsProgramOnboardingResponse
     */
     ...
     * @throws \Swagger\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayAccountClient\Model\PaymentsProgramOnboardingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsProgramOnboardingWithHttpInfo($marketplace_id, $payments_program_type)
    {
        $returnType = '\Swagger\EbayAccountClient\Model\PaymentsProgramOnboardingResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayAccountClient\Model\PaymentsProgramOnboardingResponse',
