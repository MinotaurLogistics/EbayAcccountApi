...
class ShippingOption implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'cost_type' => 'string',
        'insurance_fee' => '\Swagger\EbayAccountClient\Model\Amount',
        'insurance_offered' => 'bool',
        'option_type' => 'string',
        'package_handling_cost' => '\Swagger\EbayAccountClient\Model\Amount',
        'rate_table_id' => 'string',
        'shipping_services' => '\Swagger\EbayAccountClient\Model\ShippingService[]'
    ];
     ...
     * Gets insurance_fee
     *
     * @return \Swagger\EbayAccountClient\Model\Amount
     */
     ...
     * Sets insurance_fee
     *
     * @param \Swagger\EbayAccountClient\Model\Amount $insurance_fee insurance_fee
     *
     * @return $this
     */
     ...
     *
     * @param bool $insurance_offered This field has been deprecated. Shipping insurance is offered only via a shipping carrier's shipping services and is no longer available via eBay shipping policies.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\EbayAccountClient\Model\Amount $package_handling_cost package_handling_cost
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\EbayAccountClient\Model\ShippingService[]
     */
