...
class Region implements ModelInterface, ArrayAccess
{
     ...
     * Sets region_type
     *
     * @param string $region_type Reserved for future use. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/ba:RegionTypeEnum'>eBay API documentation</a>
     *
     * @return $this
     */
