...
class SalesTax implements ModelInterface, ArrayAccess
{
     ...
     * Sets country_code
     *
     * @param string $country_code The country code identifying the country to which this tax rate applies. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/ba:CountryCodeEnum'>eBay API documentation</a>
     *
     * @return $this
     */
