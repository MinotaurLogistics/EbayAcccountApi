...
class FulfillmentPolicy implements ModelInterface, ArrayAccess
{
     ...
     * Sets category_types
     *
     * @param \Swagger\EbayAccountClient\Model\CategoryType[] $category_types The CategoryTypeEnum value to which this policy applies. Used to discern accounts that sell motor vehicles from those that don't. (Currently, each policy can be set to only one categoryTypes value at a time.)
     *
     * @return $this
     */
     ...
     *
     * @param bool $freight_shipping If set to true, the seller offers freight shipping. Freight shipping can be used for large items over 150 lbs. Default: false
     *
     * @return $this
     */
     ...
     * Sets local_pickup
     *
     * @param bool $local_pickup If set to true, no shipping is offered by this policy and the seller offers only local pickup of the item (normally from a non-business location). This option is most often used for customer-to-customer sales and if set, costType should be set to NOT_SPECIFIED. Default: false
     *
     * @return $this
     */
