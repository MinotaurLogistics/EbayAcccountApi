...
class SetReturnPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'international_override' => '\Swagger\EbayAccountClient\Model\InternationalReturnOverrideType',
        ...
        'return_period' => '\Swagger\EbayAccountClient\Model\TimeDuration',
     ...
     * Sets category_types
     *
     * @param \Swagger\EbayAccountClient\Model\CategoryType[] $category_types For return policies, this field always returns ALL_EXCLUDING_MOTORS_VEHICLES (returns on motor vehicles are not processed through eBay flows.) Default: ALL_EXCLUDING_MOTORS_VEHICLES (for return policies only)
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\EbayAccountClient\Model\InternationalReturnOverrideType
     */
     ...
     *
     * @param \Swagger\EbayAccountClient\Model\InternationalReturnOverrideType $international_override international_override
     *
     * @return $this
     */
     ...
     * Sets marketplace_id
     *
     * @param string $marketplace_id The ID of the eBay marketplace to which this return policy applies. If this value is not specified, value defaults to the seller's eBay registration site. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/ba:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets return_method
     *
     * @param string $return_method This field indicates the method in which the seller handles non-money back return requests for remorse returns. This field is valid in only the US marketplace and the only valid value is REPLACEMENT. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:ReturnMethodEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets return_period
     *
     * @param \Swagger\EbayAccountClient\Model\TimeDuration $return_period return_period
     *
     * @return $this
     */
