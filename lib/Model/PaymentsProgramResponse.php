...
class PaymentsProgramResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string $status For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:PaymentsProgramStatus'>eBay API documentation</a>
     *
     * @return $this
     */
