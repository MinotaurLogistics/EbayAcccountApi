...
class SetPaymentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'category_types' => '\Swagger\EbayAccountClient\Model\CategoryType[]',
        'deposit' => '\Swagger\EbayAccountClient\Model\Deposit',
        'description' => 'string',
        'full_payment_due_in' => '\Swagger\EbayAccountClient\Model\TimeDuration',
        'immediate_pay' => 'bool',
        'marketplace_id' => 'string',
        'name' => 'string',
        'payment_instructions' => 'string',
        'payment_methods' => '\Swagger\EbayAccountClient\Model\PaymentMethod[]',
        'payment_policy_id' => 'string',
        'warnings' => '\Swagger\EbayAccountClient\Model\Error[]'
    ];
     ...
     * Gets category_types
     *
     * @return \Swagger\EbayAccountClient\Model\CategoryType[]
     */
     ...
     * Sets category_types
     *
     * @param \Swagger\EbayAccountClient\Model\CategoryType[] $category_types The CategoryTypeEnum value to which this policy applies. This container is used to discern accounts that sell motor vehicles from those that do not. Restriction: Currently, each policy can be set to only one categoryTypes value at a time.
     *
     * @return $this
     */
     ...
     * Gets deposit
     *
     * @return \Swagger\EbayAccountClient\Model\Deposit
     */
     ...
     * Sets deposit
     *
     * @param \Swagger\EbayAccountClient\Model\Deposit $deposit deposit
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\EbayAccountClient\Model\TimeDuration
     */
     ...
     *
     * @param \Swagger\EbayAccountClient\Model\TimeDuration $full_payment_due_in full_payment_due_in
     *
     * @return $this
     */
     ...
     * Sets marketplace_id
     *
     * @param string $marketplace_id The ID of the eBay marketplace to which this payment policy applies. If this value is not specified, the value defaults to the seller's eBay registration site. Note: A limited number of sellers, on a limited number of eBay marketplaces, are currently opted-in to the eBay managed payments program. To view the eBay marketplaces where managed payments are currently supported, see the managed payments landing page. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/ba:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name A user-defined name for this payment policy. Names must be unique for policies assigned to the same marketplace. Note: eBay will create a new payment policy for sellers who opt-in to the managed payments program.Max length: 64
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\EbayAccountClient\Model\PaymentMethod[]
     */
     ...
     * Gets warnings
     *
     * @return \Swagger\EbayAccountClient\Model\Error[]
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\EbayAccountClient\Model\Error[] $warnings A list of warnings related to request. This field normally returns empty, which indicates the request did not generate any warnings.
     *
     * @return $this
     */
