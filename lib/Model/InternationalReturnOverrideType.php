...
class InternationalReturnOverrideType implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $returns_accepted If set to true, the seller allows international returns. If set to false, the seller does not accept international returns. Required if the seller wants to set an international return policy that differs from their domestic return policy.
     *
     * @return $this
     */
