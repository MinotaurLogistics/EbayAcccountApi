...
class SetFulfillmentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'handling_time' => '\Swagger\EbayAccountClient\Model\TimeDuration',
        'local_pickup' => 'bool',
        'marketplace_id' => 'string',
        'name' => 'string',
        'pickup_drop_off' => 'bool',
        'shipping_options' => '\Swagger\EbayAccountClient\Model\ShippingOption[]',
        'ship_to_locations' => '\Swagger\EbayAccountClient\Model\RegionSet',
     ...
     *
     * @param bool $freight_shipping If set to true, the seller offers freight shipping. Freight shipping can be used for large items over 150 lbs.
     *
     * @return $this
     */
     ...
     * Sets handling_time
     *
     * @param \Swagger\EbayAccountClient\Model\TimeDuration $handling_time handling_time
     *
     * @return $this
     */
     ...
     * Sets local_pickup
     *
     * @param bool $local_pickup If set to true, no shipping is offered by this policy and the seller offers only local pickup of the item (normally from a non-business location). This option is most often used for customer-to-customer sales and if set, costType should be set to NOT_SPECIFIED.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\EbayAccountClient\Model\ShippingOption[]
     */
     ...
     *
     * @return \Swagger\EbayAccountClient\Model\RegionSet
     */
     ...
     *
     * @param \Swagger\EbayAccountClient\Model\RegionSet $ship_to_locations ship_to_locations
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\EbayAccountClient\Model\Error[] $warnings A list of warnings that were generated during the processing of the request. This field normally returns empty, which indicates the request did not generate any warnings.
     *
     * @return $this
     */
