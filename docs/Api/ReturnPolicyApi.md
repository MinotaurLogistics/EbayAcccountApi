# Swagger\EbayAccountClient\ReturnPolicyApi
...
# **createReturnPolicy**
> \Swagger\EbayAccountClient\Model\SetReturnPolicyResponse createReturnPolicy($body)
...
$apiInstance = new Swagger\EbayAccountClient\Api\ReturnPolicyApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Swagger\EbayAccountClient\Model\ReturnPolicyRequest(); // \Swagger\EbayAccountClient\Model\ReturnPolicyRequest | Return policy request
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayAccountClient\Model\ReturnPolicyRequest**](../Model/ReturnPolicyRequest.md)| Return policy request |

### Return type

[**\Swagger\EbayAccountClient\Model\SetReturnPolicyResponse**](../Model/SetReturnPolicyResponse.md)
...
# **getReturnPolicies**
> \Swagger\EbayAccountClient\Model\ReturnPolicyResponse getReturnPolicies($marketplace_id)
...
[**\Swagger\EbayAccountClient\Model\ReturnPolicyResponse**](../Model/ReturnPolicyResponse.md)
...
# **getReturnPolicy**
> \Swagger\EbayAccountClient\Model\ReturnPolicy getReturnPolicy($return_policy_id)
...
[**\Swagger\EbayAccountClient\Model\ReturnPolicy**](../Model/ReturnPolicy.md)
...
> \Swagger\EbayAccountClient\Model\ReturnPolicy getReturnPolicyByName($marketplace_id, $name)
...
# **updateReturnPolicy**
> \Swagger\EbayAccountClient\Model\SetReturnPolicyResponse updateReturnPolicy($return_policy_id, $body)
...
$body = new \Swagger\EbayAccountClient\Model\ReturnPolicyRequest(); // \Swagger\EbayAccountClient\Model\ReturnPolicyRequest | Container for a return policy request.
 ...
 **body** | [**\Swagger\EbayAccountClient\Model\ReturnPolicyRequest**](../Model/ReturnPolicyRequest.md)| Container for a return policy request. |
