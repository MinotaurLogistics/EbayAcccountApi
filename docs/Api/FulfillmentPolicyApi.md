# Swagger\EbayAccountClient\FulfillmentPolicyApi
...
> \Swagger\EbayAccountClient\Model\SetFulfillmentPolicyResponse createFulfillmentPolicy($body)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayAccountClient\Model\FulfillmentPolicyRequest**](../Model/FulfillmentPolicyRequest.md)| Request to create a seller account fulfillment policy. |

### Return type

[**\Swagger\EbayAccountClient\Model\SetFulfillmentPolicyResponse**](../Model/SetFulfillmentPolicyResponse.md)
...
> \Swagger\EbayAccountClient\Model\FulfillmentPolicyResponse getFulfillmentPolicies($marketplace_id)
...
[**\Swagger\EbayAccountClient\Model\FulfillmentPolicyResponse**](../Model/FulfillmentPolicyResponse.md)
...
> \Swagger\EbayAccountClient\Model\FulfillmentPolicy getFulfillmentPolicy($fulfillment_policy_id)
...
[**\Swagger\EbayAccountClient\Model\FulfillmentPolicy**](../Model/FulfillmentPolicy.md)
...
> \Swagger\EbayAccountClient\Model\FulfillmentPolicy getFulfillmentPolicyByName($marketplace_id, $name)
...
> \Swagger\EbayAccountClient\Model\SetFulfillmentPolicyResponse updateFulfillmentPolicy($fulfillment_policy_id, $body)
...
$body = new \Swagger\EbayAccountClient\Model\FulfillmentPolicyRequest(); // \Swagger\EbayAccountClient\Model\FulfillmentPolicyRequest | Fulfillment policy request
 ...
 **body** | [**\Swagger\EbayAccountClient\Model\FulfillmentPolicyRequest**](../Model/FulfillmentPolicyRequest.md)| Fulfillment policy request |
