# Swagger\EbayAccountClient\ProgramApi
...
# **getOptedInPrograms**
> \Swagger\EbayAccountClient\Model\Programs getOptedInPrograms()
...
$apiInstance = new Swagger\EbayAccountClient\Api\ProgramApi(
...
[**\Swagger\EbayAccountClient\Model\Programs**](../Model/Programs.md)
...
$body = new \Swagger\EbayAccountClient\Model\Program(); // \Swagger\EbayAccountClient\Model\Program | Program being opted-in to.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayAccountClient\Model\Program**](../Model/Program.md)| Program being opted-in to. |
...
$body = new \Swagger\EbayAccountClient\Model\Program(); // \Swagger\EbayAccountClient\Model\Program | Program being opted-out of.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayAccountClient\Model\Program**](../Model/Program.md)| Program being opted-out of. |
